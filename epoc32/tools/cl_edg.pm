# Cl_edg;
#
# Copyright (c) 2004-2005 Symbian Ltd.  All rights reserved.
#
...
sub PMStartBldList($) {
	...
	#my @ChopSysIncPaths=&main::Path_Chop(&main::SysIncPaths); # new style
	#my @ChopUserIncPaths=&main::Path_Chop(&main::UserIncPaths); # new style
