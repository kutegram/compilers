...
sub PrintResults
{
  ...
  # Print the Totals
  &HTMLTableRow($heading,"Total", $duration, $errorcount, $warningcount, $remarkcount, $migrationNoteCount);
  ...
  if ((defined %HiResComponents) && !$HiResErrorFlag)
  {
    foreach $component (sort {lc $a cmp lc $b} keys %HiResComponents)
	{
      ...
      # Print the Table Row
	  &HTMLTableRow($title,$component, $HiResComponents{$component}, $totalerrors, $totalwarnings,$totalremarks, $totalMigrationNotes);
	}
  } else {
    foreach $component (sort {lc $a cmp lc $b} keys %Components)
	{
      # Calculate the number errors and warnings and remarks
      my $totalerrors;
      my $totalwarnings;
      my $totalremarks;
      my $totalMigrationNotes;
      ...
      # Print the Table Row
	  &HTMLTableRow($title,$component, $Components{$component}, $totalerrors, $totalwarnings,$totalremarks, $totalMigrationNotes);
	}
  }
  ...
  if ((defined %HiResCommands) && !$HiResErrorFlag)
  {
    foreach $command (sort {lc $a cmp lc $b} keys %HiResCommands)
	{
      ...
      # Print the Table Row
	  &HTMLTableRow($title,$command, $HiResCommands{$command}, $totalerrors, $totalwarnings, $totalremarks, $totalMigrationNotes);
	}
  } else {
    foreach $command (sort {lc $a cmp lc $b} keys %Commands)
    {
      ...
      # Print the Table Row
      &HTMLTableRow($title,$command, $Commands{$command}, $totalerrors, $totalwarnings,$totalremarks, $totalMigrationNotes);
    }
  }
...
sub StartHTMLTable
{
  ...
  print HTML qq{<tr>\n};
  print HTML qq{\t<th width="55%">$iC1Title</th>\n};
  print HTML qq{\t<th width="15%">Time</th>\n};
  print HTML qq{\t<th width="15%">Errors</th>\n};
  print HTML qq{\t<th width="15%">Warnings</th>\n};
  print HTML qq{\t<th width="15%">Remarks</th>\n};
  print HTML qq{\t<th width="15%">Migration Notes</th>\n};
  print HTML qq{</tr>\n};
}
...
sub HTMLTableCell
{
   ...
   my $td = qq{td width="15%" align="center"};	# implied by the TH elements already? 
   if ($iCount != 0)
      {
...
# $iC5Data(Column 5 Data) (Number of remarks )
# $iC6Data(Column 6 Data) (Number of migration notes )
#
# Outputs
#
# Description
...
sub HTMLTableRow
{
  my ($iTitle,$iC1Data, $iC2Data, $iC3Data, $iC4Data,$iC5Data, $iC6Data) = @_;
  ...
  print HTML qq{<tr>\n};
  print HTML qq{<!--\t$linkname\t$iC2Data\t$iC3Data\t$iC4Data\t$iC5Data\t$iC6Data\t-->\n};
  print HTML qq{\t<td width="55%">$iC1Data</td>\n};
  ...
  print HTML "\t",&HTMLTableCell("remarks", $iC5Data,$linkname),"\n";
  print HTML "\t",&HTMLTableCell("migrationNotes", $iC6Data,$linkname),"\n";
