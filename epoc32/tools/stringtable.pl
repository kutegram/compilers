...
open (CPP, ">".lc("$root").".cpp" ) or die ("Error: $ARGV[0] Can't open cpp file");
open (HEADER, ">".lc("$root").".h" ) or die ("Error: $ARGV[0] Can't open header file");
