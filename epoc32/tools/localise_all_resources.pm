...
#  Description : Specific IBY file macro handling for localisation
#  Version     : %version: 2 %
#
...
##############################################################################
# Description
# Adds a LOCALISE macro that enables configuration of localised files. The
# localised language selection is done with a ADD_LANGUAGE macro.
#
# syntax: LOCALISE
...
#
# Version 2
# 11.07.2008 Teemu Rytkönen
# Ticket http://configurationtools.nmp.nokia.com/imaker/ticket/557 localise_all_resources: Add support for help files (hlp).
# Localises also *.hlp to *.h%s.
#
# Version 1
# 23.05.2007 Teemu Rytkönen
# Initial version.
#
# LOCALISE
