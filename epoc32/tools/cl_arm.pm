...
my $RVCTPatchLevel   = Armutl_RVCTPatchLevel();
...
my $ARMCCVersion = "${RVCTMajorVersion}${RVCTMinorVersion}${RVCTPatchLevel}${RVCTBuildNumber}";
...
# Move to RVCT/RVDS2.1 
# my $RVCT20 = Armutl_ArmVersion() =~ /^2\.0$/;
my $RVCT20 = 0; 
