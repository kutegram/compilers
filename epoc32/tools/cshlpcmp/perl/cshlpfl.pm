...
sub _WriteCppPrologue($$)
	...
	print $aHeaderFile "\n";
	print $aHeaderFile "//\n";
	print $aHeaderFile "// File generated by cshlpcmp ".$main::params->ParamItem("Version")->Value()."\n";
	print $aHeaderFile "//\n";
	print $aHeaderFile "\n";
...
sub _WriteOplPrologue($$)
	...
	print $aHeaderFile "\n";
	print $aHeaderFile "rem\n";
	print $aHeaderFile "rem File generated by cshlpcmp ".$main::params->ParamItem("Version")->Value()."\n";
	print $aHeaderFile "rem\n";
	print $aHeaderFile "\n";
	print $aHeaderFile "\n";
	}
