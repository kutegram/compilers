...
define CORE_HDRINFO
  ...
  $(BLR.CORE.HBY)
  $(CORE_HEADER)
  $(call select,$(USE_VARIANTBLD),1,$(VARIANT_HEADER))
endef
...
STEPS_COREPRE = $(call select,$(USE_VARIANTBLD),1,CUSTVARIANT) COREPRE

CLEAN_COREPRE = $(CLEAN_COREFILE)
BUILD_COREPRE =\
  mkcd | $(CORE_DIR) |\
  $(BUILD_COREFILE)
...
BLR.CORE.OBY   = $(call includeiby,$(CORE_OBY) $(call select,$(USE_VARIANTBLD),1,$(VARIANT_OBY)) $(BLDROBY) $(call iif,$(USE_ROFS1),$(call iif,$(USE_VERGEN),$(CORE_VERIBY))))
