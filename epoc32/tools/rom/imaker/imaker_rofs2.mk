...
define ROFS2_HDRINFO
  ...
  $(BLR.ROFS2.HBY)
  $(ROFS2_HEADER)
  $(call select,$(USE_VARIANTBLD),2,$(VARIANT_HEADER))
endef
...
BUILD_LANGFILE =\
  ...
  $(call select,$(words $(LANGPACK_LANGS)),$(words $(call getlangid,$(LANGPACK_LANGS))),,\
...
LANGPACK_LANGINFO =\
  $(foreach lang,$(call getlangid,$(LANGPACK_LANGS)),\
    $(lang)$(call select,$(lang),$(call getlangid,$(LANGPACK_DEFAULTLANG)),$(,)d)\n)

define LANGPACK_INFO
  Generated `$(LANGPACK_INFOFILE)$' for documenting the language selections

  Name         : $(LANGPACK_NAME)
  Default Lang.: $(call getlangname,$(LANGPACK_DEFAULTLANG)) ($(call getlangid,$(LANGPACK_DEFAULTLANG)))
  Languages    : $(call getlangname,$(LANGPACK_LANGS))
  Language IDs : $(call getlangid,$(LANGPACK_LANGS))
  Region       : $(call getlangregion,$(LANGPACK_DEFAULTLANG))
endef
...
STEPS_ROFS2PRE = $(call select,$(USE_VARIANTBLD),2,CUSTVARIANT) ROFS2PRE

CLEAN_ROFS2PRE = $(CLEAN_ROFS2FILE)
BUILD_ROFS2PRE =\
  mkcd | $(ROFS2_DIR) |\
  $(BUILD_ROFS2FILE)
...
BLR.ROFS2.OBY  = $(call includeiby,$(ROFS2_OBY) $(call select,$(USE_VARIANTBLD),2,$(VARIANT_OBY)) $(call iif,$(USE_VERGEN),$(ROFS2_VERIBY)))
...
getlpacksbyregion = $(strip\
  $(foreach file,$(wildcard $(LANGPACK_ROOT)/$(LANGPACK_PREFIX)*/$(LANGPACK_MKNAME)),\
    $(eval include $(file))\
    $(if $(call select,$1,all,1)$(call select,$1,$(call getlangregion,$(LANGPACK_DEFAULTLANG)),1),\
