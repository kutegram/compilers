...
define ROFS3_HDRINFO
  ...
  $(BLR.ROFS3.HBY)
  $(ROFS3_HEADER)
  $(call select,$(USE_VARIANTBLD),3,$(VARIANT_HEADER))
endef
...
STEPS_ROFS3PRE = $(call select,$(USE_VARIANTBLD),3,CUSTVARIANT) ROFS3PRE

CLEAN_ROFS3PRE = $(CLEAN_ROFS3FILE)
BUILD_ROFS3PRE =\
  mkcd | $(ROFS3_DIR) |\
  $(BUILD_ROFS3FILE)
...
BLR.ROFS3.OBY  = $(call includeiby,$(ROFS3_OBY) $(call select,$(USE_VARIANTBLD),3,$(VARIANT_OBY)) $(call iif,$(USE_VERGEN),$(ROFS3_VERIBY)))
