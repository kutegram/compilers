...
#
# GCC doesn't (yet) support the full DWARF3 format, but by using -gdwarf-2 and
# the above -g3 flag, we get as close as we can.
...
CC_WARNINGS_CONTROL_OPTION=-Wall -Wno-ctor-dtor-privacy -Wno-unknown-pragmas
