...
use constant KVersion => "Version 011";
#
use constant KProgHelp => "
\ncshlpcmp ".KVersion."
\ncshlpcmp projectfile [-lflogfile] [-odoutputdir] [-wdworkingdir]
where
...
\toutputdir is an optional override to the <output/> projectfile value
\tworkingdir is an optional override to the <working/> projectfile value
...
use constant KOutputDirPattern => "-od(".KPathRegExp.")\$";
use constant KWorkingDirPattern => "-wd(".KPathRegExp.")\$";
...
sub Initilise
    ...
    # optional outputdir
    $args->AddArgsSpec("outputdir", "",KOutputDirPattern,[],0,0);

    # optional workingdir
    $args->AddArgsSpec("workingdir", "",KWorkingDirPattern,[],0,0);
