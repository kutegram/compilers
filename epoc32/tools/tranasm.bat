...
sub UnmangleX ($)
{
	...
	if ($?) { # If c++filt returned an error code, Croak
		Croak("C++filt failed with error code: $?");
	}
...
# hack to get round 'feature' in embedded assembler stemming from the fact that
