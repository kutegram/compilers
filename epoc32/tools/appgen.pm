...
sub generate(@)
{
    ...
    open(POLICY, "> ${output_dir}/distribution.policy") or 
	$util->error("Could not write to ${output_dir}/distribution.policy");
    
    print POLICY <<_____VERBATIM_____;    
Category E
OSD:	Optional Replaceable	Software Install Tools Device Side
_____VERBATIM_____
    close POLICY;
