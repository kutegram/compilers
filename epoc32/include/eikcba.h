...
* ============================================================================
*  Name        : eikcba.h
*  Part of     : UI Framework Core / EIKON Concrete Controls
...
private: // new methods
    ...
    /*CEikCbaButton*/CCoeControl* ButtonById(TInt aCommandId) const;
...
public: // new functions
    ...
    /**
     * Changes the state of @c CEikCbaButton. Buttons state is stored in a 
     * member variable.
     *
     * @param aPressedDown The state that button has. ETrue if buttons state is 
     *                     pressed down. EFalse for normal, not pressed, state.
     */
    ...
    /**
         ...
         * @since S60 v5.0         
         */
    inline TPtrC GetFullLabelText() { return iFullLabelText;}
