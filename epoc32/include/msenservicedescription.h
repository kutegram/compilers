...
_LIT8(KSenTransportCueVirtualTCP,        "com.nokia.wsf.transport.plugin.virtualtcp"); // TODO: validate correct vTCP cue in here!
...
//_LIT8(KSenTransportSchemeVirtualTCP,        "vtcp"); // TODO: validate correct scheme
