...
*  Interface   : SDK, Toolbar API
*  Description : Popup toolbar component
*  Version     : %version: e003sa01#47 %
*
...
class CAknToolbar : public CAknControl, public MCoeControlObserver, 
    ...
    public: // New functions
        ...
        * non-focusing. Does nothing if toolbar is disabled. If flag 
        * RD_SCALABLE_UI_V2 is not defined, toolbar is always focusing. 
        * @param aVisible ETrue to show it, EFalse to hide it.
