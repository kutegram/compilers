...
/**
 * @typedef TPositionFieldId
 * @brief Standard position field identifiers. It takes one of the enumerated
 * values of #_TPositionFieldId
 */
typedef TUint16 TPositionFieldId;

/**
 * @typedef TPositionFieldIdList
 * @brief Array of standard position field identifiers
 */
