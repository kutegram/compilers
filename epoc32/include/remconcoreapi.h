...
enum TRemConCoreApiOperationId
	...
	/** This enum should have the largest value in TRemConCoreApiOperationId. To do this 
	    keep the enum entries in ascending order and keep ELargestOperationId as the last 
	    entry */
	ELargestOperationId
	};
