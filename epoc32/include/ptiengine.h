...
/**
* CPtiEngine class. 
* This is the main client side API for PtiEngine. The purpose of PtiEngine API is to provide
* a single calling point for low level (below UI) text input functionality.
...
* contains set of methods for latin based, Chinese and Japanese text input. Some
* of the methods are common for all of those variants. PtiEngine also provides access to predictive
...
NONSHARABLE_CLASS(CPtiEngine) : public CBase
    ...
    public:
        ...
        */
        ...
        /**
        * Closes current active language. After calling this method there
        ...
        */
        ...
        /**
        * Returns core info struct for given input mode. Core depends
        * on current language.
        * 
        * @since S60 V2.6                
        ...
        */
        ...
        /**
        * Returns pointer to constant language object representing
        ...
        * right core depending on currently selected language and 
        ...
        * Cycles over to the first candidate in the list after reaching
        * the last candidate. When that happens, the framework calls
        * MPtiObserver::FirstWordInSelectionList() for an observer given
        * with CPtiEngine::SetObserver() 
        *
        * @since S60 V2.6                
        ...
        * Cycles over to the last candidate in the list after reaching
        * the first candidate. When that happens, the framework calls
        * MPtiObserver::LastWordInSelectionList() for an observer given
        * with CPtiEngine::SetObserver().
        *
        * @since S60 V2.6                
        ...
        *           KErrNoSuitableCore if current language doesn't support requested input mode. 
        */
        ...
        * if currently active core object supports reordering feature.
        * It is also possible that core object supports reordering feature,
        * but it can't be turned off. Reordeing feature keeps track
        * of usage frequency for entered words and makes it possible for most frequently
        * used words to have higher priority in candidate list. Details
        * depend on underlying prediction engine.
        *
        * @since S60 V2.6                
        ...
        *
        * @since S60 V2.6                
        * @param aCase   Text case to be set. Either EPtiCaseUpper or
        *                EPtiCaseLower. 
        */
        ...
        * words into it and attaches it to currently active core
        ...
        */
        ...
        /**
        * Attach user dictionary in given file to core for given
        * input mode.  
        * 
        * @since S60 V2.6                
        ...
        */
        ...
        /**
        * Commits current word. Commiting means that core object is informed
        * that current word was accepted to be part of edited text. Word buffer
        * is cleared. Either this method or ClearCurrentWord() must be called
        * before starting a new word.
        *
        * @since S60 V2.6                
        ...
        *         EFalse Otherwise. 
        */      
        inline TBool IsQwertyBasedMode(TPtiEngineInputMode aMode) const;
...
inline TBool CPtiEngine::IsQwertyBasedMode(TPtiEngineInputMode aMode) const
    {
    if ((aMode == EPtiEngineQwerty) ||
        ...
        || (aMode == EPtiEngineHiraganaKanjiVkbRomaji)
        || (aMode == EPtiEngineHiraganaKanjiPredictiveVkbRomaji)
        )
        {
        return ETrue;   
        }
