// W32STD.H
//
// Copyright (c) Symbian Software Ltd 1994-2008.  All rights reserved.
//
...
// Functions for multiple screens
	...
	IMPORT_C TInt WindowGroupList(CArrayFixFlat<TInt>* aWindowList,TInt aScreenNumber,TInt aPriority=EAllPriorities);
	IMPORT_C TInt GetFocusWindowGroup(TInt aScreenNumber);
	IMPORT_C TInt GetDefaultOwningWindow(TInt aScreenNumber);
...
private:
	...
	TInt doWindowGroupList(
#if defined(SYMBIAN_WSERV_AND_CONE_MULTIPLE_SCREENS)
		TInt aScreenNumber,
#endif
		TInt aPriority,CArrayFixFlat<TInt>* aWindowListId,TInt aNumOpcode,TInt aListOpcode);
