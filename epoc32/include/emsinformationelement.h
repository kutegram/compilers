/* ************************************************************************
 * FILENAME: EMSInformationElement.h
 * COPYRIGHT Ericsson Mobile Communications AB 1998
 *
 * Portions Copyright (c) Symbian Software Ltd. 1997-2007.  All rights reserved.
 *
