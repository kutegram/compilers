/*
* ============================================================================
*  Name        : CAknMemorySelectionDialogMultiDrive.h
*  Part of     : Common File Dialogs / CommonDialogs.dll
*  Description : New memory selection dialog to support multiple drives.
*  Version     : %version: be1s60pr#4 % << Don't touch! Updated by Synergy at check-out.
*
...
// C_AKNMEMORYSELECTIONDIALOGMULTIDRIVE_H
#endif
